...
describe('as a dropdown item', () => {
  test('should call handleClick', () => {
    ...
    const { getByLabelText } = render(
      <ProfileListItem profile={{}} handleClick={handleClick} />,
    );

    fireEvent.click(getByLabelText(/profile-list-item/));
  ...
  test('should have hover class on item hover', () => {
    ...
    const item = getByLabelText(/profile-list-item/);
    act(() => {
...
describe('as a chosen list item', () => {
  test('should not call handleClick', () => {
    const handleClick = jest.fn();
    const { getByLabelText } = render(
      <ProfileListItem profile={{}} handleClick={handleClick} chosen />,
    );
